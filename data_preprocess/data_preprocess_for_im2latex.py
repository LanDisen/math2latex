...
# input_dir = '/data/zzengae/jwwang/final_project/labels_no_chinese/'
# output_dir = '/data/zzengae/jwwang/final_project/physic'
# output_file = '/data/zzengae/jwwang/final_project/physic/im2latex_formulas.norm1.lst'
# image_input_dir = '/data/zzengae/jwwang/final_project/formula_images_processed'
input_dir = ''
output_dir = ''
output_file = ''
image_input_dir = ''
...
with open(output_file, 'w', encoding='utf-8') as f0:
    ...
    index = 0
    with open(output_dir + 'im2latex_train_filter1.lst', 'w', encoding='utf-8') as f1:
    ...
    with open(output_dir + 'im2latex_validate_filter1.lst', 'w', encoding='utf-8') as f1:
    ...
    with open(output_dir + 'im2latex_test_filter1.lst', 'w', encoding='utf-8') as f1:
